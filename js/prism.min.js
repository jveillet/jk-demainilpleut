/* PrismJS 1.12.2
http://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+applescript+c+bash+basic+batch+cpp+csharp+coffeescript+ruby+css-extras+diff+docker+gherkin+git+graphql+haml+handlebars+http+hpkp+hsts+java+json+julia+kotlin+latex+liquid+lua+makefile+markdown+objectivec+perl+php+php-extras+powershell+properties+python+jsx+typescript+rust+sql+swift+vim+yaml&plugins=line-highlight */
